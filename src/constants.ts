...
export const APP_FEATURES_REGISTRY: FeatureDef[] = [
  ...
  },
  {
    ...
    subfeatures: [
      ...
      { id: "TEACHERS", name: "Shepherds", description: "Roster and assignments for shepherds, helpers, and staff." },
      { id: "add_member", name: "Add Member", description: "Register individual members, children, and shepherds." },
      ...
      { id: "vacation_mode", name: "Vacation Management", description: "Set temporary vacation windows for children and shepherds." },
  ...
  },
  {
    id: "Outreach",
    name: "Outreach Hub",
    description: "Shepherd-child divisions, call and visit logging, prayer durations, and coverage metrics.",
    ...
    subfeatures: [
      ...
      { id: "TRACK", name: "Progress and Analytics", description: "View monthly trend charts and shepherd outreach comparisons." },
      { id: "teacher_division", name: "Shepherd Divisions", description: "View and distribute assigned children across ministry shepherds." },
    ],
  },
  {
    id: "Analytics",
    name: "Analytics Hub",
    description: "In-depth intelligence on church demographics, retention, and shepherd engagement.",
    iconName: "PieChart",
    subfeatures: [
  ...
  },
  {
    ...
    description: "Generate structured management reports, shepherd allocations, executive summaries, and system data backups.",
    iconName: "Share2",
    subfeatures: [
      ...
      { id: "DIVISION", name: "Shepherd Division", description: "Automated distribution and allocation of children to shepherds." },
